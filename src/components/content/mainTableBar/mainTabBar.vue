  ...
  <div class="common-layout">
    <el-container>
      <el-header
        >学生生活服务管理系统
        <div class="login">
          <el-avatar :size="50" :src="avatar" @error="errorHandler">
            <img
              src=" https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png"
            />
          </el-avatar>
          <el-tag :size="size" @click="login" class="words" v-if="token === ''">
            <span>
              <span>登录</span>
            </span>
          </el-tag>
          <confirm-login v-else></confirm-login>
        </div>
      </el-header>
...
export default {
  ...
  methods: {
    login() {
      this.$router.replace("/login").catch((eer) => {
        eer;
      });
    },
